...
CREATE USER brh	IDENTIFIED BY brh DEFAULT TABLESPACE users 	QUOTA UNLIMITED ON users;
...
INSERT INTO brh.projeto (nome, responsavel, inicio, fim) VALUES ('Power BI', 'B123', to_date('2022-06-24', 'yyyy-mm-dd'), null);

SELECT* FROM brh.atribuicao; 

INSERT INTO brh.atribuicao (projeto, colaborador, papel) VALUES (5, 'A124', 2);

SELECT* FROM brh.endereco;

INSERT INTO brh.endereco (cep, uf, cidade, bairro) VALUES ('71110-400', 'PB', 'João Pessoa', 'Cabo Branco');

SELECT* FROM brh.colaborador;

INSERT INTO brh.colaborador (matricula, nome, cpf, salario, departamento, cep, logradouro, complemento_endereco) VALUES ('A124', 'Fulano de Tal', '099.999.000-00', '10000', 'DIR', '71110-400', 'Avenida Projetada', 'Casa  2');
...
INSERT INTO brh.telefone_colaborador (colaborador, numero, tipo) VALUES ('A124', '(61) 9 9999-9999', 'M');
...
INSERT INTO brh.dependente (cpf, colaborador, nome, parentesco, data_nascimento) VALUES ('023.803.531-19', 'A124', 'Beltrana de Tal', 'Filho(a)', to_date('2015-01-01', 'yyyy-mm-dd'));

INSERT INTO brh.dependente (cpf, colaborador, nome, parentesco, data_nascimento) VALUES ('753.859.426-20', 'A124', 'Cicrana de Tal', 'Cônjuge', to_date('1974-08-04', 'yyyy-mm-dd'));
...
FROM brh.dependente ORDER BY nome, colaborador;
...
INNER JOIN brh.email_colaborador B
ON A. MATRICULA = B. COLABORADOR
INNER JOIN brh.telefone_colaborador C
